...
Competitive debaters and judges flowing rounds in real time. They are at a
laptop mid-round, under time pressure, often typing while listening to a speech.
The job to be done is capturing arguments, responses, and their relationships
fast and accurately, then reviewing or exporting the flow afterward. Secondary
context: prepping and organizing past flows from the dashboard between rounds.
...
Fast, precise, invisible. The tool is an instrument, not a destination: it
should feel like a competition-grade keyboard app that rewards mastery and
disappears into the task. Voice is terse and expert; confidence comes from
speed, density, and correctness rather than decoration or hand-holding.
...
- **Speed is the feature.** Every interaction is reachable and fast from the
  keyboard; the grid responds instantly and never blocks on a speech.
- **Reserved, meaningful color.** Blue = Aff, Red = Neg, violet = selection,
  plus status hues. Color always encodes information; it is never spent on
  decoration.
- **Spreadsheet-tight, not document-soft.** Dense, gridded, legible at a glance.
  The surface reads as a precision instrument, not a doc editor or a card
  dashboard.
