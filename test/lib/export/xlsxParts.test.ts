...
import type { ExportSheet } from "@/lib/export/cells";
import {
    escXml,
    inlineCell,
    buildBodyRow,
...
describe("removeCalcChainFromRels", () => {
    ...
    it("is a no-op when calcChain is not present", () => {
        const rels =
            '<Relationships><Relationship Id="rId1" Type="worksheet" Target="sheet1.xml"/></Relationships>';
...
<mergeCells count="1"><mergeCell ref="A1:B1"/></mergeCells>
    ...
    const es: ExportSheet = {
        sheet: { id: "sh", title: "K", group: "aff", order: 0, data: [], meta: {} },
        columns: [{ id: "1ac", name: "1AC", short: "1AC", side: "aff" }],
        cells: [
            {
                col: 0,
                speechName: "1AC",
