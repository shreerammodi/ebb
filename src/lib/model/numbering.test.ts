...
describe("numberFor", () => {
  ...
  it("returns 1 for the only child", () => {
    const nodes: ArgumentNode[] = [makeNode({ id: "a", parentId: "p", order: 0 })];
  ...
  it("applies override restart: [null, 5, null] → [1, 5, 6]", () => {
    const nodes: ArgumentNode[] = [
      makeNode({ id: "a", parentId: "p", order: 0, numberOverride: null }),
      makeNode({ id: "b", parentId: "p", order: 1, numberOverride: 5 }),
      makeNode({ id: "c", parentId: "p", order: 2, numberOverride: null }),
    ];
    expect(numberFor(nodes, "a")).toBe(1);
  ...
  it("applies an override at position 0, then increments", () => {
    const nodes: ArgumentNode[] = [
      ...
      makeNode({ id: "b", parentId: "p", order: 1, numberOverride: null }),
    ];
