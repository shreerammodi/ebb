...
describe("inlineCell", () => {
    it("emits an inline-string cell", () => {
        expect(
            inlineCell("A3", { text: "hi", crossed: false, extended: false }),
    ...
    it("includes the s attribute when a column style is given", () => {
        const xml = inlineCell(
            "A3",
            { text: "hi", crossed: false, extended: false },
            41,
        );
...
describe("buildBodyRow", () => {
    it("omits empty columns and emits only filled cells", () => {
        const byCol = new Map([
            [2, { text: "y", crossed: false, extended: false }],
        ]);
    ...
    it("applies column style index when colStyles are provided", () => {
        const byCol = new Map([
            [0, { text: "hi", crossed: false, extended: false }],
        ]);
