            ...
            >
                ...
                <div className="flex min-h-0 flex-1">
                    <nav
                        ...
                        className="border-border w-[180px] shrink-0 overflow-y-auto border-r py-2"
                        ...
                        {GUIDE_SECTIONS.map((s) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    s.id === activeId && "font-medium text-foreground",
                                )}
                            >
                                {s.label}
                            </button>
                    ...
                    <div
                        ref={contentRef}
                        className="text-foreground flex-1 space-y-3 overflow-y-auto px-[22px] py-4 text-[13px] leading-relaxed"
